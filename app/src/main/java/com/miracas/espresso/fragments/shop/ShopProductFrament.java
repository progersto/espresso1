...
public class ShopProductFrament extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle s) {
        ...
        if (getArguments() != null) {
            ...
            CarouselAdapter carouselAdapter = new CarouselAdapter(this, productModel.getPopup_images());
                    ...
                    new RecyclerItemClickListener(getContext(), carousel ,new RecyclerItemClickListener.OnItemClickListener() {
                        @Override public void onItemClick(View view, int position) {
                            ...
                            if (fragmentManager != null) {
                                ...
                                bundle.putString("IMAGES", new Gson().toJson(productModel.getPopup_images()));
            ...
            price = productModel.getPrice(); discount = productModel.getDiscount();
...
//            }
            ...
            String priceOldValue = "₹" + productModel.getPrice()+"";
            ...
            if (productModel.getColor().size() == 0) {
                ...
                for(String color: productModel.getColor()) {
            ...
            if (!addedToCart) {
                if (colorOptionSelected && sizeOptionSelected) {
                    ...
                    showProgress(true);
                    AddToCartClient client = new AddToCartClient(ShopProductFrament.this,
                            selectedColor, "1", selectedSize, productModel.getPrestashopId(),
                            productModel.getProductId(), productModel.getPrice()+""
