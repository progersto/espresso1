...
public class EditAddressClient extends ARailsClient {

    public static final int code = ClientCodes.EDIT_ADDRESS;
    private Address address;

    public EditAddressClient(IOnRequestCompleted fragment, Address address) {
        super(fragment);
    ...
    protected String getBody() {
        try {
            ...
            body.put("address_id", address.id_address);
